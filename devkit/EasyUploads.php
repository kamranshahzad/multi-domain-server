...
class EasyUploads {
  ...
  function upload($theFile , $extra=''){
	  ...
	  $this->rawFilename = strtotime($today);
	  $this->rawFileextention = $this->filename_extension($this->fileInfo['name']);
	  $this->newName = $extra.$this->rawFilename.'.'.$this->rawFileextention;
