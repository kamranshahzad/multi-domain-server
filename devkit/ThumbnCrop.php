<?php
	class ThumbnCrop
	{
		...
		*/
		...
		function getNewWidthHeight($required_w_h){
			...
			if($originalWidth > $originalHeight){
				...
				$remainder = $originalWidth % $originalHeight;
				$remainder = abs($remainder);
				
				$ratio_w = $originalWidth/$remainder;
				$ratio_h = $originalHeight/$remainder;
				
				$rem = $required_w_h/$ratio_w;				
				
				$newWidth = $rem * $ratio_w;
				$newHeight = $rem * $ratio_h;	
			
			}elseif($originalHeight > $originalWidth){
			
				$remainder = $originalHeight % $originalWidth;
				$remainder = abs($remainder);
				
				$ratio_w = $originalWidth/$remainder;
				$ratio_h = $originalHeight/$remainder;
				
				$rem = $required_w_h/$ratio_h;
		...
		function createThumbRatio($required_w_h){
			$arr = $this->getNewWidthHeight($required_w_h);
			$this->createThumb($arr[0], $arr[1]);
