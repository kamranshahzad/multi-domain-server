<?php
	...
	$boot = new bootstrap();
	$routeOptions = array('view'=>array('show'=>'jscodes_view'));
	$routeParam   =  'show';
...
<title> <?php echo $boot->SITE_NAME; ?> : Manage JS Codes </title>
...
<?php echo $boot->drawVender('venders','fancybox');?>
	...
	<div class="overallwrap">
        <div class="mainwraper">
          ...
          <div class="contentwrp">
          	<div class="header"><span>JS Codes</span></div>
