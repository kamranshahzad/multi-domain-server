...
class contactusEml{
	...
	public function __construct( $_formData  ){
		...
		$this->mailObj->SetFrom('Email_ID', 'Subject');
						...
						<table cellpadding="3" cellspacing="2" border="0" width="100%">
							...
							<tr>
								...
								<table width="500" cellpadding="5" cellspacing="2" border="0">
									<tr>
										<td width="100"><strong>Fullname:</strong> &nbsp;</td>
										<td width="400">'.$this->fromData['fullname'].'</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="400">'.$this->fromData['phone'].'</td>
									</tr>
									<tr>
										<td width="100" valign="top"><strong>Comments:</strong> &nbsp;</td>
										<td width="400">'.$this->fromData['comments'].'</td>
									</tr>
									<tr>
										<td width="100"><strong>IP Address:</strong> &nbsp;</td>
										<td width="400">'.$this->fromData['ip'].'</td>
									</tr>
								</table>
								<!-- #content -->
								</td>
